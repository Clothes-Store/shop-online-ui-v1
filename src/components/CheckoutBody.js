...
import $ from 'jquery';  
import {URL_IMAGE_BASE, URL_API_BASE} from '../config'
...
function CheckoutBody(props) {
    ...
    const placeAnOrder = () => {
            ...
            cartId.push(
                {
                    ...
                    price_each:  cartList[i].current_price
                }
            )
        }
        ...
        axios.post(`${URL_API_BASE}/order`, data)
            setTimeout(()=>{ 
                setConfirm(true)
        ...
        let addressStr = addressInput + ', ' + userHuyen + ', ' + userTinh
                        ...
                        <div className="billing-detail-list comfirm-list">
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="billing-detail-mobile">
                                                ...
                                                <div className="billing-detail-price">{(item.current_price * item.count).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".")} đ</div>
                                            </div>
                                        </div>
                                    )
                                }) 
                            ...
                            <div className="billing-detail-item flex">
                                ...
                                <div className="billing-detail-mobile">
                                    <div className="billing-detail-name"></div>
                                    <div className="billing-detail-count" style={{color: '#111'}}></div>
                                    <div className="billing-detail-price billing-confirm-right" >{shipping} đ</div>
                                </div>
                            </div>
                            <div className="billing-detail-item flex">
            ...
            <div className="billing-detail">
                ...
                <div className="billing-detail-form"> 
                    <div className="billing-detail-list">
                        ...
                        {
                            userInfo && <div className="order-btn btn" onClick={placeAnOrder}>
                            PLACE AN ORDER
                        </div>
                        }

                        {
                            !userInfo && <div className="order-btn btn">
                            LOGIN TO CHECKOUT
                        </div>
                        }
