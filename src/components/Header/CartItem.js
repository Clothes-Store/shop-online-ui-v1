                            ...
                            <div className="cart-item flex" key={index}>
                                ...
                                {item.current_price &&
                                    <div className="cart-product-mobile flex">
                                        ...
                                        <div className="cart-product-price flex" style={{alignItems: 'center', justifyContent: 'center'}}>{item.current_price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".")} đ</div>
                                        <div className="cart-product-totalprice flex" style={{alignItems: 'center', justifyContent: 'center'}}>{(item.current_price * item.count).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".")} đ</div>
