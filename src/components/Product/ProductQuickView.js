                ...
                >
                    ...
                    <div className="productquickview-slide">
                        <div className="productquickview-tag">
                            {
                                product.sale > 0 && <div className="productquickview-tag-item sale">
                                    {product.sale}%
                                </div>
                            }
                            {/* {
                        ...
                        { props.view == true && 
                            <Slider {...settings}>
                                {product.imgs.map((item, index) => {
                                    return (
                                        <img key={index} src={`${URL_IMAGE_BASE}/${item.img.replace('public\\', '').replaceAll('\\','/')}`} alt="" className="view-img"/> 
                                    )
                                })}
                            </Slider>
                        }
                    ...
                    <div className="product-info-detail" style={{padding: '0', marginTop: '70px'}}>
                        ...
                        <div className="product-info-price" style={{marginTop: '30px'}}>
                                {product.current_price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".")} đ
                            </div>
                        {/* <div
                        ...
                        <div className="product-info-cate flex">
                            ...
                            <p
                                onClick={()=>{
                                    props.history.push(`/${product.type == 'Man' ? 'men' : 'women'}/${product.productCate.toLowerCase().split(' ').join('-')}`)
                                }}
