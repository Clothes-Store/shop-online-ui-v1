    ...
    return(
        <div className="ProductBody">
            <div className="product-breadcrumb flex">
                ...
                <Link to={slugSex} className="breadcrumb-item breadcrumb-link">{product.type == 'woman' ? 'Women' : 'Men'}</Link>
                <FontAwesomeIcon icon={ faAngleRight } className="breadcrumb-arrow"/>
            ...
            <div className="product-detail flex">
                <div className="product-gallery flex"
                    ...
                    <div 
                        ...
                        >
                        {product.imgs && product.imgs.map((item, index) => {
                            return (
                                <div 
                                    key={index}
                                    className={imgIndex == index ? "product-small-item product-small-item-active" : "product-small-item"}>
                                    <img 
                                        src={`${URL_IMAGE_BASE}/${item.replace('public\\', '').replaceAll('\\','/')}`}
                    ...
                    <div
                            ...
                            return (
                                <div
                                    ...
                                    style={{ 
                                        ...
                                        backgroundImage: `url(${`${URL_IMAGE_BASE}/${item.replace('public\\', '').replaceAll('\\','/')}`})`,
                        ...
                        <div className="change-product right"
                            onClick={()=> {
                                if (imgIndex < product.imgs.length && product.imgs.length) setImgIndex(imgIndex + 1)
                            }}
                            >
                ...
                <div className="product-info-detail">
                    ...
                    <div className="product-info-price">
                            {`${product.current_price}`.replace(/\B(?=(\d{3})+(?!\d))/g, ".")} Đ
                        </div>
                    {/* <div 
